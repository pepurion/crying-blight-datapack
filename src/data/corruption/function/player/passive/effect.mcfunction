...
execute as @s[scores={p_stage=1..3}] run playsound entity.warden.heartbeat player @s ~ ~ ~ 12 0.7
execute as @s[scores={p_stage=4..6}] run playsound minecraft:entity.ghast.ambient ambient @s ~ ~ ~ 12 0.5
