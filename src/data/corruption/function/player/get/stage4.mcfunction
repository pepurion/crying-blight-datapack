...
title @s title [{"translate":"crying_blight.stage.get.4","color":"red"}]
title @s subtitle [{"translate":"crying_blight.stage.get.4.sub","italic":true,"color":"blue"}]

playsound minecraft:entity.elder_guardian.curse player @s ~ ~ ~ 12 0.5
