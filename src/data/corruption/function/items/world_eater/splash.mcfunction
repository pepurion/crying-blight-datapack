...
execute as @e[type=marker,tag=World_Eater] unless predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{vehicle:{}}} at @s run function corruption:items/world_eater/summon_big
