...
execute as @e[type=marker,tag=Purification_Area] unless predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{vehicle:{}}} at @s run function corruption:items/purifier/area
