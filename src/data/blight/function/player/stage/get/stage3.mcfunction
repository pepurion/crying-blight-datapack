...
title @s title [{"translate":"text.crying_blight.stage3.get","color":"red"}]
title @s subtitle [{"translate":"text.crying_blight.stage3.get.sub","italic":true,"color":"dark_purple"}]
