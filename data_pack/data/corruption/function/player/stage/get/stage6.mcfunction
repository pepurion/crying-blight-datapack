...
title @s title [{"translate":"crying_blight.stage6.get","color":"dark_purple"}]
title @s subtitle [{"translate":"crying_blight.stage6.get.sub","italic":true,"color":"dark_purple"}]
